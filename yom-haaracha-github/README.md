...
- **רשימה שלמה:** מדביקים את כל 40 בבת אחת, שורה לכל אחד בפורמט `שם, קוד`.
...
**סבב הריאיון:** בטבלת הנבחנים, בעמודה "ריאיון בסבב", יש לכל נבחן תפריט לבחירת הסבב שבו יתקיים הריאיון שלו. מעל הטבלה מוצג **פיזור הריאיונות** (היעד: עד 8 בסבב, כמספר המראיינים) כדי לאזן בקלות. עדיף לקבוע זאת לפני תחילת המבחן.
